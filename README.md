...
[![Demo](https://img.shields.io/badge/Demo-Download-orange.svg)](https://github.com/Nightonke/BoomMenu/blob/master/Apk/BoomMenu%20V2.0.5.apk?raw=true)
...
##Gradle & Maven
```
compile 'com.nightonke:boommenu:2.0.5'
```
```
<dependency>
...
Or by link:  
[Boom V2.0.5 in Github](https://github.com/Nightonke/BoomMenu/blob/master/Apk/BoomMenu%20V2.0.5.apk?raw=true)  
[Boom V2.0.5 in Fir](http://fir.im/tv85)  
